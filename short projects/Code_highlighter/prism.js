/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+c+cpp+css-extras+diff+http+hpkp+hsts+ignore+java+javadoclike+jsdoc+json+json5+js-templates+kotlin+markup-templating+mongodb+php+powershell+python+jsx+tsx+regex+rest+typescript&plugins=line-highlight+line-numbers+custom-class+file-highlight+jsonp-highlight+highlight-keywords+remove-initial-line-feed+inline-color+previewers+autoloader+keep-markup+command-line+unescaped-markup+normalize-whitespace+data-uri-highlight+toolbar+copy-to-clipboard+download-button+match-braces+diff-highlight+filter-highlight-all+treeview */
var _self =
